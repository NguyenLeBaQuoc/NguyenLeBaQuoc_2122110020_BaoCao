...
<body>
            ...
            <div class="col-12 col-sm-12 d-none d-md-block col-md-4 text-center py-2">
               <div class="call-login--register border-bottom">
                  <ul class="nav nav-fills py-0 my-0">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="profile.html">Nguyễn Lê Bá Quốc</a>
                     </li>
                  </ul>
               </div>
               <div class="fs-6 py-2">
   ...
   <section class="nlbq-mainmenu bg-main">
      <div class="container">
         <div class="row">
            <div class="col-12 col-md-12">
               <nav class="navbar navbar-expand-lg bg-main">
                  <div class="container-fluid">
                     <a class="navbar-brand d-block d-sm-none text-white" href="index.html">SHOP 78</a>
   ...
   <section class="nlbq-maincontent py-2">
      <div class="container">
         <div class="row">
            <div class="col-md-3 order-2 order-md-1">
               <ul class="list-group mb-3 list-page">
                  ...
                  <li class="list-group-item">
                     <a href="post-page.php">Chính sách mua hàng</a>
                  </li>
                  <li class="list-group-item">
   ...
   <section class="nlbq-footer pb-4">
      <div class="container">
         <div class="row">
   ...
   <section class="dhl-copyright bg-dark py-3">
      <div class="container text-center text-white">
         Thiết kế bởi: Bùi Hải Dương - Phone: 0971885850
      </div>
   </section>
</body>
